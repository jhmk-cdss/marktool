...
echo "$Project_HOME"
LOG_DIR=/data/1/CDSS/cloud/bzgjPro/logs
APPLICATION_MAIN=com.jhmk.model.ModelApplication
...
JAVA_OPTS="-Dspring.profiles.active=$EVN -Duser.timezone=GMT+8 -server -Xms512m -Xmx1024m -Xloggc:${LOG_DIR}/gc.log"
